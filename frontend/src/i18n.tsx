...
const translations = {
  en: {
    ...
    compareSubtitle: "Select a country to see how Russia's missile spending compares to its economy.",
    compareEducation: "Education budget",
    compareYears: "years",
    compareMissileCost: "Russia's missile cost",
    compareCouldFund: "could fund",
    compareEduBudgetFor: "'s education budget for",
    comparePerCitizen: "Missiles per capita",
    comparePerMillion: "per million",
    compareMissilesPerMillion: "missiles & drones per million people in",
    compareSalary: "Salary equivalent",
    compareMonths: "months",
    compareSalaryExplain: "of average wages per citizen spent on missiles in",
  ...
  uk: {
    ...
    compareSubtitle: "Оберіть країну, щоб побачити, як ракетні витрати Росії порівнюються з її економікою.",
    compareEducation: "Бюджет освіти",
    compareYears: "років",
    compareMissileCost: "Вартість ракет Росії",
    compareCouldFund: "могла б профінансувати",
    compareEduBudgetFor: " бюджет освіти на",
    comparePerCitizen: "Ракети на душу",
    comparePerMillion: "на мільйон",
    compareMissilesPerMillion: "ракет та дронів на мільйон населення в",
    compareSalary: "Еквівалент зарплати",
    compareMonths: "місяців",
    compareSalaryExplain: "середньої зарплати на громадянина витрачено на ракети в",
